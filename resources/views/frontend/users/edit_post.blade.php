...
@section('content')
    <div class="col-lg-9 col-12">
        ...
        {!! Form::model($post, ['route' => ['users.update.post', $post->id], 'method' => 'put', 'files' => true]) !!}
        ...
        <div class="form-group">
            ...
            {!! Form::textarea('description', old('description',$post->description), ['class' => 'summernote']) !!}
        ...
        <div class="row">
            ...
            <div class="col-4">
                ...
                {!! Form::select('comment_able', ['1' => 'Yes', '0' => 'No'],old('comment_able',$post->comment_able),
                ['class' => 'form-control']) !!}
                @error('comment_able')<span class="text-danger">{{ $message }}</span>@enderror
            </div>
            <div class="col-4">
                {!! Form::label('status', 'Status') !!}
                {!! Form::select('status', ['1' => 'Active', '0' => 'Inactive'],old('status',$post->status),
                ['class' => 'form-control']) !!}
        ...
        <div class="row">
            <div class="col-12">
                {!! Form::file('images[]', ['id' => 'post-images', 'multiple' => 'multiple']) !!}        </div>
