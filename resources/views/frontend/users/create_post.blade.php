...
@section('content')
    <div class="col-lg-9 col-12">
        <h3>Create Post</h3>
        {!! Form::open(['route' => 'users.store_post','method'=>'post','files' => true])!!}
        ...
        <div class="form-group">
            ...
            {!! Form::textarea('description', old('description'), ['class' => 'summernote']) !!}
        ...
        <div class="row">
            ...
            <div class="col-4">
                ...
                {!! Form::select('comment_able', ['1' => 'Yes', '0' => 'No'],old('comment_able'),
                ['class' => 'form-control']) !!}
